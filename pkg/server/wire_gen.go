...
func Initialize(cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	v2 := appregistry.ProvideAppInstallers(playlistAppInstaller, alertingNotificationsAppInstaller)
	...
	repositorySecrets := secrets.ProvideRepositorySecrets(featureToggles, secretsService, secureValueClient, decryptService, cfg)

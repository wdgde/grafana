...
func Initialize(cfg *setting.Cfg, opts Options, apiOpts api.ServerOptions) (*Server, error) {
	...
	collectionAppInstaller, err := collection.RegisterApp(featureToggles, cfg, sqlStore)
	if err != nil {
		return nil, err
	}
	v2 := appregistry.ProvideAppInstallers(playlistAppInstaller, collectionAppInstaller)

...
import (
	...
	"github.com/grafana/grafana/pkg/services/pluginsintegration/pluginresource"
...
var WireSet = wire.NewSet(
	...
	pluginresource.ProvideService,
	wire.Bind(new(registry.Service), new(*pluginresource.Registry)),
	repo.ProvideService,

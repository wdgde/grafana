...
type NamespacedClient[T resource.Object, L resource.ListObject] = contracts.NamespacedClient[T, L]
...
func (c *newSecureValueClient) Client(ctx context.Context, namespace string) (NamespacedClient[*secretv1beta1.SecureValue, *secretv1beta1.SecureValueList], error) {

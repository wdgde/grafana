...
func (_m *MockSecureValueClient) Client(ctx context.Context, namespace string) (contracts.NamespacedClient[*v1beta1.SecureValue, *v1beta1.SecureValueList], error) {
	...
	var r0 contracts.NamespacedClient[*v1beta1.SecureValue, *v1beta1.SecureValueList]
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (contracts.NamespacedClient[*v1beta1.SecureValue, *v1beta1.SecureValueList], error)); ok {
		return rf(ctx, namespace)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) contracts.NamespacedClient[*v1beta1.SecureValue, *v1beta1.SecureValueList]); ok {
		r0 = rf(ctx, namespace)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(contracts.NamespacedClient[*v1beta1.SecureValue, *v1beta1.SecureValueList])
		}
	}
...
func (_c *MockSecureValueClient_Client_Call) Return(_a0 contracts.NamespacedClient[*v1beta1.SecureValue, *v1beta1.SecureValueList], _a1 error) *MockSecureValueClient_Client_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockSecureValueClient_Client_Call) RunAndReturn(run func(context.Context, string) (contracts.NamespacedClient[*v1beta1.SecureValue, *v1beta1.SecureValueList], error)) *MockSecureValueClient_Client_Call {
	_c.Call.Return(run)
	return _c
}

...
// Source: apps/dashboard/kinds/v1beta1/dashboard_spec.cue
...
PanelOrRowPanel: {
    ...
    type: string & strings.MinRunes(1) | "row"
...
VariableType: "query" | "adhoc" | "groupby" | "constant" | "datasource" | "interval" | "textbox" | "custom" |
    "system" | "snapshot" @cuetsy(kind="type")
...
// Row panel
// FIXME: This is not generated for some reason.
RowPanel: {
    // The panel type
    type: "row"

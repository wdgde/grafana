...
require (
	...
	github.com/grafana/grafana/apps/dashboard v0.0.0-20250530094111-5b4d1886383b
	github.com/grafana/grafana/pkg/apimachinery v0.0.0-20250530094111-5b4d1886383b
